...
class ProductRepositoryPostgres extends ProductRepository {
  ...
  async addProduct(newProduct) {
    const {
      productName, unitId, categoryId, stockNow, stockMin, unitPrice, image,
      hargaBeli,
    } = newProduct;
    ...
    const query = {
      ...
      values: [productId, barcode, productName, unitId, categoryId, stockNow, stockMin, unitPrice, hargaBeli, image],
    };
