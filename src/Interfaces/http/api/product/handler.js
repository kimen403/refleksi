...
class ProductHandler {
  ...
  async getProductsHandler(request, h) {
    ...
    const getAllProductUseCase = this._container.getInstance(GetAllProductUseCase.name);
  ...
  async getMinStockHandler(request, h) {
    const getMinStockUseCase = this._container.getInstance(GetMinStockUseCase.name);
