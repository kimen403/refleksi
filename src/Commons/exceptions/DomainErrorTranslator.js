...
DomainErrorTranslator._directories = {
  ...
  'POST_TRANSAKSI_USE_CASE.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError(
  ...
  'NEW_TRANSAKSI_PENJUALAN.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError(
    'tidak dapat membuat transaksi baru karena tipe data tidak sesuai',
  ),
